...
def main(notebook_root, wiki_root, user_name, attach_dir, page_path):
    ...
    deploy_page_path = os.path.join(wiki_root, 'data', 'pages', user_name, os.path.relpath(page_path, notebook_root)).lower()
    deploy_media_dir = os.path.join(wiki_root, 'data', 'media', attach_relative_dir).lower()
